...
def main():
    ...
    for file_info in file_data:
        ...
        leetcode_url = get_leetcode_url(problem_number, filename) if problem_number else f"https://leetcode.com/problems/{base_name.replace('_', '-')}/"
        ...
        csv_data.append({
            ...
            'Difficulty': '',  # User can fill in manually
